---
title: Notes on Installing Tanzu Application Platform 1.7 (Full Profile) on EKS
tags: ["Kubernetes", "Cartographer", "EKS", "ECR", "Tanzu", "TAP"]
categories: ["Dev", "CaaS", "Kubernetes", "TAP"]
date: 2023-12-12T12:14:16Z
updated: 2024-01-15T02:40:21Z
---
...
### Creating a ClusterIssuer for Let's Encrypt (HTTP01 challenge)
...
### (Optional) Installing Metrics Server
...
💾 Source
   type:    source image
   image:   532912407632.dkr.ecr.ap-northeast-1.amazonaws.com/tap-lsp:demo-hello-world@sha256:cff5552ec1c0e57e14f7ff7060bc308fd8f002facdf683795814130d73258aa
...
### Dynamic Provisioning of PostgreSQL with Bitnami Service
...
### Dynamic Provisioning of RDS with AWS Services
...
> ⚠️ If the `SYNCED` status of the subnetgroup remains `False`, and you see the error
>
> ``` 
...
> ```
>
> it is likely that the `AWSServiceRoleForRDS` role is missing. This error may occur if you are using RDS for the first time. In this case, run the following command:
>
> ```
