...
[Previously](/entries/847) we explained how to launch a Spring Batch job without using a DB on Spring Batch 5 / Spring Boot 3, but in Spring Batch 6 / Spring Boot 4 a DB is **not required by default** ([link](https://spring.io/blog/2025/07/23/spring-batch-6#resourceless-batch-infrastructure-by-default)).
