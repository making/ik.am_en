---
title: Notes on running Qwen3.8-27B with llama.cpp on DGX Spark and using it from Claude Code
tags: ["DGX Spark", "ASUS Ascent GX10", "llama.cpp"]
categories: ["HomeLab", "DGXSpark"]
summary: Explains how to run Qwen3.8-27B locally on DGX Spark with llama.cpp and use it from Claude Code. Covers build, systemd setup, Jinja template, Claude Code integration.
date: 2026-08-17T06:03:34.858Z
updated: 2026-08-19T06:27:04.228Z
---

> ⚠️ This article was automatically translated by OpenAI API (unsloth/Qwen3.6-27B-MTP-GGUF:Q4_K_XL).
...
If the following Jinja template is not set for `--chat-template-file`, the following error message was shown from Claude Code.
...
### Operation check from Claude Code
