...
This time, I'll push to GitHub Container Registry before installing. To push to GitHub Container Registry, you need a GitHub Personal Access Token.
...
While not required, I'll also push the Helm chart to GitHub Container Registry:
...
Connect to the LoadBalancer's EXTERNAL-IP on port 5432. The password for the `gpadmin` user is stored in a Secret:
...
Connect to the LoadBalancer's EXTERNAL-IP on port 8080:
