---
title: Tanzu Application Platform 1.3のMulti Cluster TopologyでAKSにインストールするメモ
tags: ["Kubernetes", "Cartographer", "AKS", "Tanzu", "TAP", "Knative", "Azure"]
categories: ["Dev", "CaaS", "Kubernetes", "TAP", "MultiCluster"]
---


[Tanzu Application Platform 1.3](https://docs.vmware.com/en/Tanzu-Application-Platform/1.3/tap//GUID-overview.html) を [Multi Cluster Topology](https://docs.vmware.com/en/VMware-Tanzu-Application-Platform/1.3/tap/GUID-multicluster-about.html) でAKSにインストールします。
